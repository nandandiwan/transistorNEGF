...
class GreensFunction:
    ...
    def compute_electron_density(self, E, self_energy_method=None, use_rgf=False):
        """
...
def rgf(device, hamiltonian, E, compute_lesser=True, **kwargs):
    """
    ...
    return gf.compute_central_greens_function(E, compute_lesser, **kwargs)


def transmission(device, hamiltonian, E, **kwargs):
    """
    ...
    """
    gf = GreensFunction(device, hamiltonian)
    return gf.approx_compute_transmission(E,**kwargs)


def dos(device, hamiltonian, E, **kwargs):

    gf = GreensFunction(device, hamiltonian)
    return gf.compute_density_of_states(E, **kwargs)